    ...
    <div className='container gaegu-regular'>     
      ...
      <button onClick={fnAddCnt}>증가!</button> */}
        ...
        <div className="input-group">
          이름 :
          <input type="text" placeholder='은호' id="userName" value={userName} onChange={(e) => setUserName(e.target.value)}>
          </input>
        </div>
        <div className="input-group">
          아이디 : <input type="text" placeholder='enho' onChange={fnIdCheck} value={userId}></input>
        ...
        <div className="input-group">
          주소 : <input type="text" placeholder='인천시 부평구' value={addr} onChange={(e) => setAddr(e.target.value)}></input>
        </div>
