...
function Profile() {
    ...
    const handleClick1 = () => {
        // 페이지 이동을 원하는 URL로 설정합니다.
        const newPageUrl = "/Detail"; // 디테일 페이지의 URL을 설정합니다.
        ...
        <div id="container">
            ...
            <div className="sidebar">
                <div className="user-settings orbit-regular">
                    <h4>설정</h4>
                    <ul className="userSettings2">
                        <li><a href="#" onClick={handleClick}>내프로필</a></li>
                        <li><a href="#" onClick={handleClick}>보안설정</a></li>
                        <li><a href="#" onClick={handleClick}>이력관리</a></li>
                    </ul>
                </div>
            </div>
            <div className="profile-posts orbit-regular">
                <h5>내가 작성한 게시글</h5><br/><br/><br/>
                <div className="row">
                    {list.map(item => (
                        <div className="col-sm-6 col-md-4 col-lg-4" key={item.id}>
                             <a href="#" onClick={handleClick1}> {item.title}</a>
                             <p>{item.content}</p>
                        </div>
                    ))}
                </div>
